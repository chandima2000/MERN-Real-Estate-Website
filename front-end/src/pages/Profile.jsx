...
function Profile() {
    ...
    const [userListings, setUserListings] = useState([]); //This is an empty array.
...
const handleSignOut = async () => {
    try {
         ...
         const res = await fetch('/api/auth/signout') // since this use "GET" request, no need to mention the method.
         const data = await res.json()  // Convert response to the JSON format.
         if(data.success === false){
        ...
        <div className="p-3 max-w-lg mx-auto">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    ...
                    <p className='text-sm self-center'>
                        ...
                        <button 
                             disabled = {loading}
                             className="bg-slate-700 p-3 text-white uppercase hover:opacity-95 rounded-lg"
                             >
